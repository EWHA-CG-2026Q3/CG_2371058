...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(45, 215);
    [SerializeField] private Vector2 vertexB = new Vector2(30, 45);
    [SerializeField] private Vector2 vertexC = new Vector2(220, 95);
    [SerializeField] private Color fillColor = new Color(1f, 0.45f, 0.65f, 1f);
